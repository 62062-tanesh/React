    ...
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div >
            ...
            <p className='my-6 text-[15px] text-gray-500'>
                This is useful for creating clean product photos, professional profile pictures, <br className='max-md:hidden'/> or visuals for marketing and design, making the subject stand out on any backdrop.
